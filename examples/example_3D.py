...
slices = slicer.slice_stl(stl_file,0.1)
my_part = Part.Part()
my_part.create_from_mplt_paths(slices)

manuf = manufacturing_settings.ManufacturingSetting()
my_part.set_layers(0.1, manuf, size=60, angle_between_layers=10, melt_strategy="point_random", nmb_of_scans=1, sorting_strategy="shapes_first")
